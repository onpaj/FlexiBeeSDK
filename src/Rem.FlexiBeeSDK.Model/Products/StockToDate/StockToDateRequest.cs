...
public class StockToDateRequest
{
    ...
    public string Detail { get; set; } =
        "custom:cenik(nazev,kod,id,baleniNazev1,baleniMj1,evidSarze,evidExpir,objem,hmotMj,dodavatel,poznam),eanKod,id,mj1(nazev,kod,id),nazev,pozadavkyMJ,prumCena,skupZboz(nazev,kod,id),stavMJ,stavMJPozad,stitky,tuz";
